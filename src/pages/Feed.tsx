...
// ── Inline sign-in buttons (Apple + Google) for feed gates ────────────────
const InlineSignInButtons = () => {
  ...
  return (
    <div className="space-y-2">
      <button
        ...
        disabled={!!loading}
        className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl bg-white text-gray-800 font-semibold text-base shadow-md active:scale-95 transition-transform disabled:opacity-60"
      >
        {loading === 'apple' ? (
