...
// Re-export from lightweight mapping file for backward compat
export { QUIZ_BRAIN_MAP, MODULE_BRAIN_MAP, getRegionFromQuizId, getRegionFromModuleId } from './feedBrainMapping';
