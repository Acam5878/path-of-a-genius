...
import { REGIONS, COURSE_REGION_MAP } from './brainRegions';

// Re-export from the lightweight regions file so existing imports still work
export { REGIONS, COURSE_REGION_MAP };
