    ...
    <div className="min-h-[100dvh] bg-[hsl(220,40%,4%)] text-white overflow-y-auto relative">
      ...
      {!revealed && (
        <motion.div
          ...
          style={{ background: 'linear-gradient(180deg, hsla(220,40%,4%,0.3) 0%, hsla(220,40%,4%,0.85) 40%, hsla(220,40%,4%,0.95) 100%)' }}
        >
          {/* Score peek */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <p className="text-white/40 text-sm max-w-xs mx-auto leading-relaxed">
              Your full cognitive profile is ready. See your estimated IQ, strengths, and growth potential.
            </p>
          </motion.div>
