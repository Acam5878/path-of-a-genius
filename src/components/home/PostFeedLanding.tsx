...
export const PostFeedLanding = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-[hsl(220,40%,4%)] text-white overflow-y-auto relative">
      ...
      <div className={revealed ? '' : 'filter blur-[6px] pointer-events-none select-none'}>
        {/* ── Hero ─────────────────────────────────────────────── */}
        ...
        {/* ── Brain Comparison (SVG placeholders — no WebGL) ──── */}
        <section className="px-6 pb-8">
          <div className="max-w-md mx-auto">
            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col items-center">
                <p className="text-[10px] font-mono uppercase tracking-widest text-white/40 mb-3">Your Brain Now</p>
                <div className="w-full rounded-2xl overflow-hidden bg-white/[0.02] flex items-center justify-center" style={{ height: 200 }}>
                  <Brain className="w-16 h-16 text-secondary/30" />
                </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="w-full rounded-2xl overflow-hidden bg-white/[0.02] flex items-center justify-center" style={{ height: 200 }}>
                  <Brain className="w-16 h-16 text-secondary/60" />
                </div>
                <div className="mt-3 flex items-center gap-1">
        ...
        <section className="px-6 pb-8">
          <div className="max-w-sm mx-auto">
            <p className="text-[10px] font-mono uppercase tracking-widest text-white/30 mb-4 text-center">What's included</p>
        ...
        <section className="px-6 pb-8">
          <div className="max-w-sm mx-auto space-y-2.5">
            ...
            {[
              ...
              <div key={i} className="bg-white/[0.03] border border-white/[0.06] rounded-xl px-4 py-3 flex items-start gap-3">
      ...
      {/* ── Blur overlay CTA (shown when not revealed) ────── */}
      {!revealed && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          style={{ background: 'linear-gradient(180deg, hsla(220,40%,4%,0.15) 0%, hsla(220,40%,4%,0.7) 30%, hsla(220,40%,4%,0.92) 60%)' }}
        >
          {/* Score peek */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <p className="text-[10px] font-mono uppercase tracking-widest text-secondary/60 mb-3">Analysis Complete</p>
            <h1 className="font-heading text-3xl md:text-4xl font-bold leading-tight mb-3">
              Your brain scored{' '}
              <span className="text-secondary">{nowCount}/{totalRegions}</span>
            </h1>
            <p className="text-foreground/60 text-sm max-w-xs mx-auto leading-relaxed mb-1">
              Your full cognitive profile is ready.
            </p>
            <p className="text-secondary/90 text-sm font-semibold max-w-xs mx-auto">
              See your estimated IQ, personalised curriculum & growth plan.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              See Full Analysis & Personalised Curriculum
            </button>
            <button
