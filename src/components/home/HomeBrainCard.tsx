...
const MODULES = [
  ...
  { id: 'physics', icon: '🔬', label: 'Natural Philosophy', region: 'rightParietal', pathSlug: 'physics', desc: 'Natural Philosophy engages the Right Parietal Lobe — where spatial modelling and physical intuition reside. Understanding forces and motion builds powerful spatial reasoning.' },
